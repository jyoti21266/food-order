...
<div class="wrapper">
      ...
      <table>
          ...
          <tr>
                ...
                <td><a href="<?php echo SITEURL; ?>register.php" class="white">register?</a></td>
                
          </tr>
          <tr>
              <td><a href="<?php echo SITEURL; ?>admin/login.php" class="white">Admin?</a></td>
    </tr>
      </table>
        </form>
...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql1="SELECT user_id FROM users WHERE password='$password' AND user_name='$username'";
    ...
    if($res==true){
        ...
        if($count==1){
         ...
         $_SESSION['login']="<div class='failure'>Wrong username!!!</div>";
