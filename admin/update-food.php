...
?>
    ...
    <div class="wrapper">
        <h1 class="banner">Update Food</h1>
        <br><br>
        ...
        <table class="width-30">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Food" class="up-btn">
                </td>
            </tr>
                    ...
                    if($image_name!="")
                    {
                        ...
                        if($current_image!="")
                        {
                            ...
                            if($remove==false)
                            {
                                ...
                                $_SESSION['remove-failed'] = "<div class='failure'>Faile to remove current image.</div>";
                                //redirect to manage food
                                header('location:'.SITEURL.'admin/manage-food.php');
                                //stop the process
                                die();
